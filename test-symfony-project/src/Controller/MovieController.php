...
class MovieController extends AbstractController
{
   ...
   private $descriptions = [
    1 => 'Фильм о том как эльфу искали закуску к пиву',
    2 => 'Фильм про шикарные пельмеши',
    3 => 'Фильм про темное прошлое Насти из П-31',
    4 => 'Фильм про возвращение Насти в РМТ'
];
    ...
    public function show(int $id): Response
    {
         ...
         $movie->description = $this->descriptions[$id] ?? 'Описание отсутствует';
